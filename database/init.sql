...
CREATE TABLE working_faces (
    ...
    name VARCHAR(200) NOT NULL COMMENT '工作面名称',
...
(1, 'dust', '1101工作面粉尘传感器1', 10.0000, 'mg/m3'),
(1, 'temperature', '1101工作面温度传感器1', 30.0000, 'C'),
(1, 'wind', '1101工作面风速传感器1', 0.2500, 'm/s'),
(2, 'gas', '1202工作面瓦斯传感器1', 1.0000, '%'),
(2, 'dust', '1202工作面粉尘传感器1', 10.0000, 'mg/m3'),
(2, 'temperature', '1202工作面温度传感器1', 30.0000, 'C'),
(2, 'wind', '1202工作面风速传感器1', 0.2500, 'm/s'),
(3, 'gas', '1303工作面瓦斯传感器1', 1.0000, '%'),
(3, 'dust', '1303工作面粉尘传感器1', 10.0000, 'mg/m3'),
(3, 'temperature', '1303工作面温度传感器1', 30.0000, 'C'),
(3, 'wind', '1303工作面风速传感器1', 0.2500, 'm/s'),
(4, 'gas', '1404工作面瓦斯传感器1', 1.0000, '%'),
(4, 'wind', '1404工作面风速传感器1', 0.2500, 'm/s'),
(4, 'dust', '1404工作面粉尘传感器1', 10.0000, 'mg/m3'),
(4, 'temperature', '1404工作面温度传感器1', 30.0000, 'C');
