...
async function migrate() {
    try {
        ...
        console.log('✅ alarm_records 表创建成功');

        const [rows] = await db.query('SELECT COUNT(*) as count FROM information_schema.tables WHERE table_schema = DATABASE() AND table_name = ?', ['alarm_records']);
